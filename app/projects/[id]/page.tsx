...
const projects = [
  {
    ...
    category: "Frontend",
    image: "/project1.jpg",
    screenshots: ["/project1a.png", "/project1b.png", "/project1c.png", "/project1d.png", "/project1e.png", "/project1f.png"],
  ...
  "City De Fitness is a modern fitness brand platform designed to deliver an immersive, high-energy digital fitness experience. The project focuses heavily on premium UI/UX design with bold typography, dark themes, fluid animations, and responsive layouts that reflect the intensity and energy of a real gym environment. The platform also integrates live virtual workout sessions and real-time video coaching powered by JaaS (Jitsi as a Service) and WebRTC technology, allowing trainers and clients to connect directly through secure browser-based video sessions. This project is currently under active development.",
    ...
    category: "Frontend",
    image: "/project9.jpg",
    screenshots: ["/project9.jpg", "/project1a.png", "/project1b.png", "/project1c.png", "/project1d.png", "/project1e.png", "/project1f.png"], 
  ...
  },
  {
    ...
    category: "Frontend",
    image: "/project12.jpg",
    screenshots: [ "/project12a.png", "/project12b.png", "/project12c.png", "/project12d.png", "/project12e.png", "/project12f.png", "/project12g.png", "/project12h.png", "/project12i.png", ],
  ...
  },
  {
    ...
    category: "Blockchain",
    image: "/project10.jpg",
    screenshots: ["/project10a.png", "/project10b.png", "/project10c.png", "/project10d.png", "/project10e.png", ],
  ...
  },
  {
    ...
    category: "Frontend",
    image: "/project6.jpg",
    screenshots: [ "/project6a.png", "/project6b.png", "/project6c.png", "/project6d.png", "/project6e.png","/project6.jpg",],
  ...
  },
  {
    ...
    category: "Frontend",
    image: "/project8.jpg",
    screenshots: ["/project8a.png", "/project8b.png", "/project8c.png", "/project8d.png", "/project8e.png",],
